...
// https://github.com/dotnet/wcf/blob/master/src/System.Private.ServiceModel/src/Internals/System/Runtime/IOThreadScheduler.cs
    ...
    internal class IOThreadScheduler
    {
        ...
        unsafe class ScheduledOverlapped
        {
            ...
            void IOCallback(uint errorCode, uint numBytes, NativeOverlapped* nativeOverlapped)
            {
                ...
                this.scheduler = null;
                Debug.Assert(iots != null, "Overlapped completed without a scheduler.");
            ...
            {
                Debug.Assert(this.scheduler == null, "Post called on an overlapped that is already posted.");
